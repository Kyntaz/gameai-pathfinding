...
public class PathfindingManager : MonoBehaviour {
	...
	private PathSmoothing Smoother = new PathSmoothing();
    ...
    void Update () 
    {
        ...
        if (!this.AStarPathFinding.InProgress && this.currentSolution != null && !smoothed)
        {
            this.currentSolution = Smoother.SmoothPath(this.currentSolution);
			this.smoothed = true;
        }
    }
